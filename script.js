...
let cards = [
    ...
    { word: "Explain the Bank of Englands role in being the Issuer of banknotes.", description: "The Bank of England has a duty to ensure an adaquate supply of notes is in circulation.", topic: "1" },
    { word: "Explain the Bank of Englands role in being the 'Banker to the goverment'.", description: "It is the holder of the goverments own account. The BOE provides fiinance to cover any deficit by making automatic loans. If there is a surplus the Bank may lend it out as part of it's general debt management policy (DMP).", topic: "1" },
    { word: "Explain the Bank of Englands role in being the 'Banker to the banks'.", description: "All major banks have accounts with the BOE for depositing or obtaining cash. In this capacity, the BOE can wield cosiderable influence over the rates of interest in various money markets by changing the rates it charges banks for borrowing or depositing.", topic: "1" },
